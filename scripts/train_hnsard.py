...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--lambda-pos", default=0.05, type=float)
    parser.add_argument("--lambda-con", default=0.05, type=float)
    ...
    parser.add_argument("--tiny-weight", default=1.5, type=float)
    parser.add_argument("--small-weight", default=1.25, type=float)
